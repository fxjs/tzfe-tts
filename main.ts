...
function validateContentType(req: Request, expected: string) {
  ...
  if (contentType !== expected) {
    log(`Invalid Content-Type ${contentType}, expected ${expected}`);
...
serve(
  ...
  },
  {
    ...
    onListen(info: any) {
      ...
      console.log('Server started::', obj, ', open', `http://${obj.hostname}:${obj.port}`);
      console.log(':)');
      console.log('');
    },
  }
